...
# ╔═╡ 47c8378a-6b59-11ef-06e5-85672f349b7a
begin
...
# ╔═╡ 20242dd1-7de1-4d0f-9142-df535dfdf468
begin
...
# ╔═╡ ecc4daec-25bc-4ef9-a43c-79b51a14741c
if shuffl
	design =
    SingleSubjectDesign(;
        conditions = Dict(
...
# ╔═╡ 188f110d-32b9-4728-b205-fde900a6b424
@bind offs PlutoUI.Slider(0:10:200, default = 80, show_value = true)

# ╔═╡ e5f6e85f-8023-462b-9e67-87c77a869927
offs
...
begin
	...
	data, evts = simulate(
	    ...
	    design,
	    components,
	    UniformOnset(; width = w, offset = offs),
	    PinkNoise(;noiselevel = nl),
	);
end

# ╔═╡ addb9e2c-f9f7-436c-9c53-2c5cd4de0ab9
m = fit(
    UnfoldModel,
...
# ╔═╡ ba961054-0c7c-4b73-a350-53339863f7fa
plot_erp(
    coeftable(m);
    axis = (
...
# ╔═╡ 77c94c44-8b73-422c-a26c-4e8d3e96262a
lines(data[500:1500])
...
manifest_format = "2.0"
project_hash = "a98a1f1a05f4effe54c4fb6cdd7b04d00438c4ab"
